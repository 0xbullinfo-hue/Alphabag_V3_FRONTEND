...
export const AlphaCalls: React.FC = () => {
    ...
    return (
        <div className="relative min-h-[calc(100vh-12rem)] flex flex-col pb-20 w-full animate-in fade-in duration-700">
            ...
            {/* Header */}
            <div className="bg-alphabag-darkgray border-y border-alphabag-gray -mx-2 rounded-none p-4 flex flex-col md:flex-row justify-between items-start md:items-center gap-2 mb-2">
                <div>
