...
export const CexBag: React.FC = () => {
    ...
    const CustomTooltip = ({ active, payload }: any) => {
        if (active && payload?.length) {
            ...
            return (
                <div className="bg-alphabag-black border border-alphabag-gray rounded-md px-4 py-3 shadow-xl text-sm">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-2">
                ...
                <div className="lg:col-span-2 space-y-2">
                                        ...
                                        <div key={i} className="flex items-center gap-2">
                                            ...
                                            <div className="flex-1 min-w-0">
                                                <div className="flex justify-between items-center text-xs mb-1">
                                                    <span className="font-semibold text-alphabag-text truncate">{d.name}</span>
                                                    <span className="font-semibold text-alphabag-text tabular-nums shrink-0 ml-2">${d.value.toLocaleString(undefined, { minimumFractionDigits: 2 })}</span>
                                                </div>
                    ...
                    <div className="rounded-lg border border-alphabag-gray bg-alphabag-darkgray overflow-hidden">
                        <div className="px-6 py-4 border-b border-alphabag-gray">
                            <h3 className="text-xs font-semibold uppercase text-alphabag-subtext tracking-wider">Unified Balances</h3>
                        </div>
