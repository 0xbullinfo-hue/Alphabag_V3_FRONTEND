...
export const GenesisLanding: React.FC = () => {
    ...
    return (
        ...
        />
            ...
            <nav className="fixed top-0 w-full z-50 bg-alphabag-black/80 backdrop-blur-xl border-b border-white/5">
                <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
                    <div className="flex items-center space-x-2">
                        <div className="w-8 h-8 bg-alphabag-yellow text-black flex items-center justify-center rounded-lg ">
                    ...
                    <div className="flex items-center space-x-2">
                        ...
                        <Button size="sm" onClick={handleClaimSpot} className="uppercase font-black tracking-widest px-4 py-1.5 h-9 text-[10px]  rounded-lg">
                            Claim Spot
                        </Button>
                    </div>
                </div>
            ...
            {/* Hero Section */}
            <main className="relative pt-32 pb-2 px-6 max-w-7xl mx-auto flex flex-col items-center text-center">
                <div className="inline-flex items-center space-x-2 bg-alphabag-darkgray/80 border border-alphabag-yellow/30 rounded-full px-4 py-1.5 mb-2 backdrop-blur-md ">
                ...
                <h1 className="text-5xl md:text-7xl font-black mb-2 tracking-tighter uppercase leading-none animate-fade-in-up">
                ...
                {/* Live Counter */}
                <div className="bg-alphabag-darkgray border border-white/10 rounded-xl p-4 mb-12 relative overflow-hidden group shadow-glass animate-fade-in-up delay-200">
                ...
                <div className="flex flex-col items-center space-y-2 animate-fade-in-up delay-300">
                    <Button 
                        ...
                        className="group relative px-10 py-3 text-lg font-black transition-all hover:scale-105 active:scale-95 bg-alphabag-yellow text-black  rounded-xl"
                    >
                ...
                {/* Core Benefits */}
                <div className="grid grid-cols-1 md:grid-cols-3 gap-2 mt-20 w-full animate-fade-in-up delay-500">
                    <GenesisBenefit 
...
const GenesisBenefit = ({ icon, title, desc }: { icon: any, title: string, desc: string }) => (
    <div className="bg-alphabag-darkgray/30 backdrop-blur-xl border border-white/5 p-4 rounded-xl text-left hover:border-alphabag-yellow/20 transition-all group overflow-hidden relative">
        
        <div className="mb-2 bg-alphabag-black/50 w-12 h-12 rounded-lg flex items-center justify-center border border-white/5 group-hover:scale-110 transition-transform">
            {icon}
        </div>
