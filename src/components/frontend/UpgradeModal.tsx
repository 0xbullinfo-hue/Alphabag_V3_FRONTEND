          ...
          <div className="flex justify-between items-center mb-8">
            <div className="flex items-center space-x-3">
              ...
              <h2 className="text-2xl font-black text-white tracking-tighter uppercase leading-none text-left">
                Alpha<span className="text-alphabag-yellow">BAG</span> <span className="block text-[10px] text-alphabag-subtext tracking-[0.2em] mt-1 font-bold">Genesis Node Upgrade</span>
              </h2>
            </div>
